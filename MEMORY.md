# GodotScaffolding 项目记忆

> 文档双职责：
> - **📍 项目状态**（上方）：本项目当前阶段、进度、下一步——开工先看
> - **经验沉淀**（下方）：跨项目复用的快速检索表 / 通用原则 / 实例档案 / 维护指南

---

## 📍 项目状态

> **本项目专属**，随开发推进更新；下方经验区为跨项目通用知识，相对稳定。
...
> Story 级细粒度进度见 `docs/06_story/00_总表.md`。
