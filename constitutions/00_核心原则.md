...
| 适用 Skill | `godot-architect`, `godot-best-practices`, `godot-gdscript-patterns`, `godot-ui`, `sprite-analyzer` |

## 🎮 Godot Skill 编排指南

项目使用 5 个专业化 Godot 4.x Skill，各司其职、通过明确的工作流串联。
...
| 编写 GDScript 实现代码 | `godot-best-practices` |
